...
*   내용을 작성하지 않아도 된다.
*   이 때 와일드 카드(*) 를 이요해서 포괄적인 URL 패턴을 이용할 수 있다.
*  */
public class ClassMappingTestController {
    ...
    public String modifyOrder(Model model) {
        ...
        model.addAttribute("message",
                "POST 방식의 주문 정보 수정과 주문 정보 석제 공통 처리용" +
                        "핸들러 메소드 호촐됨...");
    ...
    *   path variable 로 전달되는 { 변수명 } 은 반드시 매개변수 명과 동일해야 한다.
    ...
    *  */
    ...
    public String selectOrderDetail(Model model, @PathVariable("orderNo") int orderNo2){
        ...
        model.addAttribute("message",
                orderNo2 + "번 상세 내용 조회용 핸들러 메소드 호출됨...");
